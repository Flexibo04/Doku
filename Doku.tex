...
URL-Pfade (\texttt{/setup}, \texttt{/erp}, \texttt{/pane}) vorgesehen
...
\begin{longtable}{@{} l l p{9cm} @{}}
  ...
  FA04 & Frontend & \texttt{App.tsx}: AppBridge-Initialisierung über
                   \texttt{@jtl-software/cloud-apps-core}; URL-basiertes Routing
...
\begin{itemize}[leftmargin=1.5em]
  ...
  \item Kein Produktions-Deployment; kein HTTPS-Terminations-Setup beschrieben.
\end{itemize}
